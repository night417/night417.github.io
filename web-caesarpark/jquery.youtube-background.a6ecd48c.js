...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"../js/youtube-video-fullscreen-background/jquery.youtube-background.js":[function(require,module,exports) {
/* jquery.youtube-background v1.0.7 | Nikola Stamatovic <@stamat> | MIT */
var tag = document.createElement('script');
tag.src = "https://www.youtube.com/player_api";
var firstScriptTag = document.getElementsByTagName('script')[0];
firstScriptTag.parentNode.insertBefore(tag, firstScriptTag); //native addClass, removeClass, hasClass and toggleClass
  ...
  if (window.hasOwnProperty('YT')) {
    this.player = new YT.Player(this.uid, {
      events: {
        ...
        'onError': function onError(event) {//console.error('player_api', event);
        }
      }
    });
  }
...
YoutubeBackground.prototype.buildHTML = function () {
  var parent = this.element.parentNode; // wrap
...
function ActivityMonitor(on_activity, on_inactivity, activity_timeout, inactivity_timeout, events) {
  ...
  this.resetTimer = function () {
    ...
    this.timer = setTimeout(function () {
      if (self.last_activity + self.timeout + self.activity_timeout >= new Date().getTime()) {
        if (on_inactivity) {
          on_inactivity();
        }
      }
...
function VideoBackgrounds(selector, params) {
  ...
  this.__init__ = function () {
    ...
    this.initYTPlayers(function () {
      //TODO: FIX!
      if (params && (params.hasOwnProperty('activity_timeout') || params.hasOwnProperty('inactivity_timeout'))) {
        this.activity_monitor = new ActivityMonitor(function () {
          self.playVideos();
        }, function () {
          self.pauseVideos();
        }, params ? params.activity_timeout : null, params ? params.inactivity_timeout : null, ['mousemove', 'scroll']);
      }
    });
  };
...
},{}]},{},["C:/Users/User/AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","../js/youtube-video-fullscreen-background/jquery.youtube-background.js"], null)
//# sourceMappingURL=/jquery.youtube-background.a6ecd48c.js.map